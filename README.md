...
###  3.1. <a name='initiateRegistration'></a>`initiateRegistration`
...
###  3.2. <a name='initiateSigning'></a>`initiateSigning`
...
####  4.1.4. <a name='FullAndroidExample'></a>Full Android Example
